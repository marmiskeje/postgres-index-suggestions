...
namespace IndexSuggestions.IndexAnalysis
{
    ...
    internal class EvaluateIndicesEnvironmentsCommand : ChainableCommand
    {
        ...
        public EvaluateIndicesEnvironmentsCommand(DesignIndicesContext context, IVirtualIndicesRepository virtualIndicesRepository, IExplainRepository explainRepository,
                ...
                foreach (var env in context.IndicesDesignData.IndicesEnvironments)
                {
                    try
                    {
                        ...
                        foreach (var kv in env.PossibleIndices.AllPerStatement)
                        {
                            ...
                            env.PlansPerStatement.Add(statementID, latestPlan);
