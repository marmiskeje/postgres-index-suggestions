...
namespace DiplomaThesis.DAL
{
    internal partial class DiplomaThesisContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<NormalizedStatementStatistics>().HasIndex(x => new { x.Date });
            ...
            modelBuilder.Entity<NormalizedStatementIndexStatistics>().HasIndex(x => new { x.Date });
            ...
            modelBuilder.Entity<NormalizedStatementRelationStatistics>().HasIndex(x => new { x.Date });
            ...
            modelBuilder.Entity<TotalIndexStatistics>().HasIndex(x => new { x.DatabaseID, x.Date });
            ...
            modelBuilder.Entity<TotalStoredProcedureStatistics>().HasIndex(x => new { x.DatabaseID, x.Date });
            ...
            modelBuilder.Entity<TotalViewStatistics>().HasIndex(x => new { x.DatabaseID, x.Date });
            ...
            modelBuilder.Entity<WorkloadAnalysis>().HasIndex(x => x.CreatedDate);
            modelBuilder.Entity<WorkloadAnalysis>().HasIndex(x => x.WorkloadID);
            modelBuilder.Entity<VirtualEnvironment>().HasOne(x => x.WorkloadAnalysis).WithMany(x => x.VirtualEnvironments);
            modelBuilder.Entity<VirtualEnvironment>().HasIndex(x => new { x.WorkloadAnalysisID, x.Type });
            ...
            modelBuilder.Entity<VirtualEnvironmentStatementEvaluation>().HasKey(x => new { x.VirtualEnvironmentID, x.NormalizedStatementID, x.ExecutionPlanID  });
            ...
            modelBuilder.Entity<WorkloadAnalysisRealStatementEvaluation>().HasKey(x => new { x.WorkloadAnalysisID, x.NormalizedStatementID, x.ExecutionPlanID  });
            ...
            modelBuilder.Entity<VirtualEnvironmentPossibleCoveringIndex>().HasKey(x => new { x.VirtualEnvironmentID, x.NormalizedStatementID, x.PossibleIndexID });
