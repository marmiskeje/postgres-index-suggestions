...
namespace IndexSuggestions.DAL
{
    internal static class IndexSuggestionsContextSeedDataUtility
    {
        public static void SeedData(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<SettingProperty>().SeedData(new SettingProperty() { ID = 2, Key = SettingPropertyKeys.REPORTING_SETTINGS, StrValue = SerializeToJson(reportingSettings)});
            ...
            modelBuilder.Entity<SettingProperty>().SeedData(new SettingProperty() { ID = 3, Key = SettingPropertyKeys.SMTP_CONFIGURATION, StrValue = SerializeToJson(smtpConfiguration) });
            ...
            modelBuilder.Entity<SettingProperty>().SeedData(new SettingProperty() { ID = 4, Key = SettingPropertyKeys.EMAIL_TEMPLATE_SUMMARY_REPORT, StrValue = SerializeToJson(summaryReportTemplate) });
        }
